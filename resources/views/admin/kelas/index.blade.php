            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" onchange="reqJurusan(this.value)"
                                            id="jurusan_id">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" onchange="reqTingkat(this.value)"
                                            id="tingkat_id">
                        ...
                        <div class="col-md-12">
                            <table class="table" id="kelas_table">
                                <thead>
                                    <tr>
                                        <th>Nama</th>
                                        <th>Jurusan</th>
...
@section('js')
    <script>
        ...
        function seeStudent(id) {
            var url = '{{route('admin.kelas.show', ':id')}}';
            window.location = url.replace(':id', id);
        }

        function editData(id){
            var url = "{{route('admin.kelas.edit', ':id')}}";
            window.location = url.replace(':id', id);
        }

        function deleteData(id,nama) {
            var url = '{{ route('admin.kelas.destroy', ':id') }}';
            swal({
                    title: 'Hapus kelas',
