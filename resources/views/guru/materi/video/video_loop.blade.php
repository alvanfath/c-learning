...
@section('content')
    <div class="row">
            ...
            <div class="col-12 col-md-4 col-lg-4">
                <article class="article article-style-c">
                    <div class="article-header">
                        <div class="article-image" data-background="{{ asset('materi/thumbnail_video/belajar.jpg') }}">
                        </div>
                    </div>
                    <div class="article-details">
                        ...
                        <div class="article-title">
                            <h2><a href="{{route('guru.materi.video_details', Crypt::encryptString($item->id))}}">{{ $item->judul }}</a></h2>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                              <div class="empty-state" data-height="400">
                                ...
                                <p class="lead">
                                  Maaf materi video untuk {{$nama}} masih belum tersedia untuk saat ini
                                </p>
                              </div>
                            </div>
                          </div>
        ...
        <div class="col-12 col-md-12 col-lg-12">
            <a href="{{ route('guru.materi.video') }}" class="btn btn-secondary">Kembali</a>
        </div>
    </div>
