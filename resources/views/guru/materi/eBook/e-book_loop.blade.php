...
@section('content')
    <div class="row">
                ...
                <article class="article article-style-c">
                    ...
                    <div class="article-details">
                        ...
                        <div class="article-title">
                            <h2><a href="{{route('guru.materi.download.ebook', Crypt::encryptString($item->id))}}">{{ $item->judul }}</a></h2>
                        </div>
        ...
        <div class="col-12 col-md-12 col-lg-12">
            <a href="{{ route('guru.materi.ebook') }}" class="btn btn-secondary">Kembali</a>
        </div>
    </div>
