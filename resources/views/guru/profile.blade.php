        ...
        <div class="col-12 col-md-12 col-lg-5">
            <div class="card profile-widget">
                <div class="profile-widget-header">
                    <img alt="image" id="uploadedAvatar" src="{{ asset('upload_images/guru/' . $guru->gambar) }}"
                    ...
                    <div class="profile-widget-items">
                        <div class="profile-widget-item">
                            ...
                            <div class="profile-widget-item-value">{{ $guru->mapel->nama }}</div>
                        </div>
                    </div>
                </div>
                <div class="ml-3">
                ...
                <div class="ml-3 mt-1">
                    <form action="{{route('guru.profile.update_gambar', $guru->id)}}" method="post" id="upload-image"
                    ...
                    <form action="{{route('guru.profile.remove_gambar', $guru->id)}}" id="remove_gambar" class="d-none" method="post">@method('put') @csrf</form>
                </div>
                <div class="profile-widget-description">
                    <div class="profile-widget-name">{{ $guru->nama }} <div
                            class="text-muted d-inline font-weight-normal">
                            <div class="slash"></div> guru
                        </div>
                    </div>
                    guru bertugas untuk mengatur data materi dan sub materi yang ada di sekolah ini sesuai dengan mata pelajaran yang dipegang
                </div>
            </div>
            <div class="card">
                <form action="{{route('guru.profile.update_password', $guru->id)}}" method="post">
                    @csrf
                    @method('put')
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 col-12">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ $guru->jurusan->nama }}" readonly>

                            </div>
                            <div class="form-group col-md-12 col-12">
                                <label>Email</label>
                                <input type="email" class="form-control"
                                    value="{{ $guru->tingkat->tingkat_kelas }}" readonly>
                            </div>
                            <div class="form-group col-md-12 col-12">
                                <label>Mata Pelajaran</label>
                                <input type="text" class="form-control"
                                    value="{{ $guru->mapel->nama }}" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer text-right">
